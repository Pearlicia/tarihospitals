                            ...
                            <div className="about-widget">
                                ...
                                <ul className="widget-contact-info">
                                    <li className="info-address">
                                        ...
                                        Agudama, Yenagoa, Nigeria.
                                    </li>
                                    <li className="info-mail">
                                        <i className="icofont-email"></i>
                                        <a href="mailto://info@tarihospitals.com">
                                            tarihospitals@gmail.com
                                        </a>
                                    </li>
                                    <li className="info-phone">
                                        <i className="icofont-ui-call"></i>
                                        <a href="tel://+2348050690216">
                                            +234 805 069 0216
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div className="row text-center">
                        <div className="col-sm-12">
                            <div className="widget-copyright">
                                <p>
                                    &copy; 2022{" "}
                                    <span className="text-uppercase">Tari</span>
                                    . Made with{" "}
                                    <i className="icofont-heart-alt"></i> by{" "}
                                    <a
                                        target="_blank"
                                        href="https://www.pearlicia.com"
                                        rel="noreferrer"
                                    >
                                        Pearlicia
                                    </a>
