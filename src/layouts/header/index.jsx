                        ...
                        <div className="row row-cols-2">
                            <div className="col">
                                <p>
                                    ...
                                    <span>ADDRESS:</span>Assemblies of God road,
                                    Agudama, Yenagoa
                                </p>
                            </div>
                            <div className="col">
                                <ul className="social-links text-end">
                                    <li>
                                        <SocialIcon
                                            path="https://twitter.com/tarhospitals"
                                            icon="icofont-twitter"
                                        />
                                    </li>
                                    <li>
                                        <SocialIcon
                                            path="https://www.facebook.com/tarhospitals"
                                            icon="icofont-facebook"
                                        />
                                    </li>
                                    <li>
                                        <SocialIcon
                                            path="https://www.instagram.com/tarhospitals"
